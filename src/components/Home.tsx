    ...
    return (
        <div >
            ...
            <div className="flex justify-center items-center flex-col  pt-[10%]">
                <p className="font-semibold text-6xl dark:text-white text-black">HEY, I'M RAYEN KANZARI</p>
                ...
                <button className="bg-green-500 w-[13vw] max-w[250px] h-[60px] mt-[4%] dark:text-white text-black ">Projects</button>
            </div>
        </div>
